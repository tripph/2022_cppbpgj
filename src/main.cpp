...
// configuration step. It creates a namespace called `2022_cppbpgj`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        2022_cppbpgj::cmake::project_name,
        2022_cppbpgj::cmake::project_version));// version string, acquired
